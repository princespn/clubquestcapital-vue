<template>
    <div class="container-fluid login-background-img h-100">
        <div class="row h-100">
            <div class="col-12 col-md-5 col-lg-6 col-xl-8">
                <div class="admin-logo mt-5 text-left">
                    <img src="user-assets/images/login-logo.svg" />
                </div>
            </div>
            <div class="col-12 col-md-7 col-lg-6 col-xl-4 align-items-center d-flex justify-content-center">
                <div class="login-white-box text-left">
                    ...
                    <form class="mt-5 login-form position-relative" action="" @submit.prevent="login">
                        <div class="form-group">
                            <input type="email" class="form-control form-input" placeholder="User ID"  @blur="NameValidation($event)" name="user_id" id="user_id" required="" v-model="user.user_id" autofocus="">
                                 <div v-if="nameErr !== ''" class="tooltip1">
                                 <span class="text-danger">{{ this.nameErr }}</span>
                                </div>
                        </div>
                        <div class="form-group active position-relative">                          
                            <input  type="password" class="form-control form-input"  placeholder="Password" name="password" id="password" v-model="user.password">
                        ...
                        <div class="prove-human mb-3">
                            ...
                            <div class="cust-checkbox-new">
                                <label class="cust-chk-bx">
                                    <input v-model="terms" class="custom-switch-input" type="checkbox" id="terms" name="terms" data-vv-as="recaptcha"  v-on:click="cheboxpopup" tabindex="3" aria-required="true" aria-invalid="false">
                        ...
                        <div class=" text-center">
                            <button type="submit"  :disabled="!loginComplete || !terms" class="login-blue-btn">Login</button>
                        </div>
                        <div class="frt-link">
...
<script>
    ...
    import {LOGIN,GENERATERANDNO} from "@/store/actions.type";
         ...
         mixins: [ValidatioMixin],
            ...
            showPass() {
             if (this.showpassword == 0) {
               ...
               this.eye = "bi bi-eye fs-2";
               this.showpassword = 1;
             } else if (this.showpassword == 1) {
               document.getElementById("password").type = "password";
               this.showpassword = 0;
               this.eye = "bi bi-eye-slash fs-2";
             }
           },
                    login() {
                        // axios.post('login', {
