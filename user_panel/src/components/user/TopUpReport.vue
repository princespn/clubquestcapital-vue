            ...
            <div class="row">
                <div class="col-12">
                    <div class="comn-title">
                        <h2 class="f-size-22">Topup Report</h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="deposite-datatable position-relative">
                        <div class="table-responsive  mt-3">
                            <div id="structure-balance-receive_wrapper"
                                            ...
                                            <div class="date-picker-filter-topup">
                                                ...
                                                <div class="form-group mr-3">
                                                    ...
                                                    <div class="input-group date-picker-input-topup align-items-center">
                                                        <input type="text" class="form-control repot-search-input" placeholder="Deposit Id" name="deposit-id" id="deposit-id">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="downline-topup-report" v-once
...
import Navbar from '../../components/user/Navbar.vue';
  ...
  export default {
      ...
      getConfirmedDeposite() {
        ...
        setTimeout(function () {
          ...
          that.table = $("#downline-topup-report").DataTable({
            ...
            // ],
            ajax: {
              url: serveApiUserHost + "topup-report",
              type: "POST",
              data: function (d) {
                i = 0;
                i = d.start + 1;
   ...
   $("#downline-topup-report").on("click", "#Updatelokingstatus", function () {
