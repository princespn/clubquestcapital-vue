            ...
            <div class="row">
                <div class="col-12">
                    <div class="comn-title">
                        <h2 class="f-size-22">Direct Earnings Report</h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="deposite-datatable position-relative">
                        <div class="table-responsive  mt-3">
                            <div id="structure-balance-receive_wrapper"
                                            ...
                                            <div class="date-picker-filter-topup">
                                                ...
                                                <div class="form-group mr-3">
                                                    ...
                                                    <div class="input-group date-picker-input-topup align-items-center">
                                                        <input type="text" class="form-control repot-search-input"
                                                             placeholder="Enter User Id"  name="user-id" id="user-id">
                                                ...
                                                <div class="ml-3">
                                                    <button type="button"  name="signup1" value="Sign up" id="onSearchClick" class="filter-search-btn">Search</button>

                                                </div>
                                                <div class="ml-3">
                                                    <button type="button" name="signup1" value="Sign up" id="onResetClick"   class="filter-search-btn">Reset</button>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="direct-income-report" v-once
...
import { serveApiUserHost,domainReferralLink } from "../../../user_config";
export default {
    components: { Navbar },
  data() {    
    return {
    ...
    getConfirmedDeposite() {
      ...
      setTimeout(function () {
        that.table = $("#direct-income-report").DataTable({
          ...
          // ],
          ajax: {
            url: serveApiUserHost + "direct-income",
            type: "POST",
            data: function (d) {
              i = 0;
              i = d.start + 1;
            ...
            dataSrc: function (json) {
              if (json.code === 200) {
                ...
                location.href=domainReferralLink+'login';
                // location.reload();
              }else {
                // json['draw'] = 0;
