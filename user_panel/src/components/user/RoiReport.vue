      ...
      <div class="row">
        <div class="col-12">
          <div class="comn-title">
            <h2 class="f-size-22">RIO Earnings Report</h2>
          </div>
        </div>
      </div>
              ...
              <div id="structure-balance-receive_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                ...
                <div class="row">
                  <div class="col-sm-12 mt-5">
                    <table id="roi-income-report" v-once class="main-datatable table   display dataTable no-footer"
  ...
  export default {
    ...
    methods: {
      ...
      getRoi() {
        ...
        setTimeout(function () {
          that.table = $("#roi-income-report").DataTable({
            lengthMenu: [
              [10, 50, 100],
              [10, 50, 100],
            ],
            ...
            ajax: {
              url: serveApiUserHost + "roi-income",
              type: "POST",
              data: function (d) {
                i = 0;
                i = d.start + 1;
            ...
            columns: [{
              ...
              {
                render: function (data, type, row) {
                  return `<span>$${row.on_amount.toFixed(2)}</span>`;
                },
              },
              {
                render: function (data, type, row) {
